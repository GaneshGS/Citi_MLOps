    ...
    <Tabs defaultValue="config" className="w-full min-w-0">
      ...
      <TabsContent value="config" className="min-w-0 pt-3">
        <div className="space-y-3">
          ...
          {mode === "unstructured" && config.gssp_enabled && (
            <p className="text-xs text-muted-foreground">
              GSSP URL, path, credentials, and pass-through headers are configured on the
              Studio server (environment variables), not in this UI.
            </p>
          )}
